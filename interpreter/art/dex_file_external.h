...
#define ADEXFILE_ERROR_OK 0
#define ADEXFILE_ERROR_INVALID_DEX 1
#define ADEXFILE_ERROR_INVALID_HEADER 2
#define ADEXFILE_ERROR_NOT_ENOUGH_DATA 3
#define ADEXFILE_ERROR_LIB_NOT_LOADED 0xff

typedef uint32_t ADexFile_Error; // NOLINT
