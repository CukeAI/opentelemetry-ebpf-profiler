...
type UnwindInfo struct {
	Opcode, FPOpcode, RealFPOpcode, ArchDefOpcode, ArchDef1Opcode, ArchDef2Opcode, MergeOpcode uint8

	Param, FPParam, RealFPParam, ArchDefParam, ArchDef1Param, ArchDef2Param int32
}
